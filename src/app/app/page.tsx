    ...
    <div className="min-h-screen flex items-center justify-center py-20">
      <div className="container">
        <div className="max-w-md mx-auto text-center">
          ...
          <h1 className="text-2xl md:text-3xl mb-3">Sign in to continue</h1>
          <p className="text-[var(--gray-500)] mb-8">
            Access your SpaceLogic dashboard to manage projects and generate professional exports.
          </p>
          ...
          <Link
            href="/demo"
            className="inline-flex items-center gap-2 text-[var(--primary)] font-medium hover:text-[var(--primary-hover)] transition-colors"
          >
            Try the demo first
